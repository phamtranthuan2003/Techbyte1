...
<div class="w-full max-w-lg p-8 bg-white shadow-xl rounded-2xl">
    ...
    <form action="{{ route('admins.providers.store') }}" method="post" class="space-y-4">
        @csrf
        
        <!-- Tên Nhà Cung Cấp -->
        <div>
            <label for="name" class="block text-sm font-semibold text-gray-700">Tên Nhà Cung Cấp</label>
            <input type="text" id="name" name="name" required value="{{$provider->name}}"
        ...
        <div>
            ...
            <input type="text" id="address" name="address" required value="{{$provider->address}}"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-300 focus:outline-none">
        </div>
        ...
        <div>
            ...
            <input type="tel" id="phone" name="phone" required value="{{$provider->tele}}"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-300 focus:outline-none">
        </div>
        ...
        <button type="submit"
            ...
            <i class="fa fa-plus mr-2"></i>Sửa Nhà Cung Cấp
        </button>
    </form>
</div>
